...
let CommentController = class CommentController {
    getComments() {
        return __awaiter(this, void 0, void 0, function* () {
            return new commentRepo_1.CommentRepository().getComments();
        });
    }
    createComment(body) {
        return __awaiter(this, void 0, void 0, function* () {
            return new commentRepo_1.CommentRepository().createComment(body);
        });
    }
    getComment(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return new commentRepo_1.CommentRepository().getComment(Number(id));
        });
    }
};
__decorate([
